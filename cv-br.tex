...
\cvitem{Básico}{ARM Assembly, Lua, JavaScript, PHP, SQL}
\cvitem{Intermediário}{Haskell, Go, Sistemas operacionais GNU/Linux, Programação Paralela (pthreads, openMP e MPI), Shell Script, git, \LaTeX{}, Java}
